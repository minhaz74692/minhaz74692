# 💫 About Me:
I'm currently working on [QuantiaLab](https://quantialab.mx)(Remote), Guadalajara, Jalisco, Mexico.
...
|---------|------|-------------|
| **Quantia project(Naia residencial, Noa CRM)** | Java, Spring Boot, PostgreSQL, ReactJS, Flutter, OpenAI API | AI-powered platform with voice & text features. |
| **Sales Management** | Spring Boot, PostgreSQL, ReactJS | Full-stack solution for managing sales & clients. |
| **Quiz App** | Flutter, Provider | Cross-platform quiz application with HTTP API integration. |
| **LMS Community** | Flutter, Riverpod | Learning management system community feature with clean architecture. |
